...
describe('NFT contract with mint game contract', function () {
  ...
  beforeEach(async function () {
    ...
    const AnimaVerseCollection = await ethers.getContractFactory('AnimaVerseCollectionWithGame')
  ...
  describe('NFT Mint', function () {
    it('whitelist mint', async function () {
      const wlMintCount = await AnimaVerseCollectionInstance.MAX_MINT()
      const wlMintPrice = await AnimaVerseCollectionInstance.MINT_PRICE()
